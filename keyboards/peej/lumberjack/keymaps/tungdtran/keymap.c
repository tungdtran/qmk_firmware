 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |  Ins | Home | PgUp | PrtSc| ScrLk| Pause| |      | ISO #| ISO /|      |      |      |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |  Del |  End | PgDn |      |             | |             |      |      |      |      |
 * `-----------------------------------------' `-----------------------------------------'
 */
[_LOWER] = LAYOUT_ortho_5x12(
    KC_GRV,  KC_TILD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    KC_INS,  KC_HOME, KC_PGUP, KC_PSCR, KC_SCRL, KC_PAUS, _______, KC_NUHS, KC_NUBS, _______, _______, _______,
    KC_DEL,  KC_END,  KC_PGDN, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
